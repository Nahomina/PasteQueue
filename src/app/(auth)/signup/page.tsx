...
import { Clipboard, Loader2, Lock, Mail, User, CheckCircle2 } from "lucide-react";
      ...
      <div className="hidden lg:flex flex-col justify-between bg-indigo-600 p-10 text-white">
        ...
        <div className="space-y-6">
          <h2 className="text-3xl font-bold leading-tight">
            Your clipboard,<br />finally under control.
          </h2>
          <ul className="space-y-3 text-indigo-100 text-sm">
            {[
              "Capture every copy automatically",
              "Search your entire history instantly",
              "Sync across all your devices",
              "Transform content with one click",
            ].map((f) => (
      ...
      <div className="flex flex-col items-center justify-center px-6 py-12 bg-background">
        <div className="w-full max-w-sm space-y-8">
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/login" className="font-medium text-indigo-600 hover:text-indigo-700 underline-offset-4 hover:underline">
              Sign in
            </Link>
          </p>
          ...
          <p className="text-center text-xs text-muted-foreground/60">
            ...
            <br />© {YEAR} PasteQueue. All rights reserved.
          </p>
        </div>
      </div>
    </div>
